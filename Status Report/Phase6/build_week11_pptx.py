"""Build Week 11 Status Report PPTX — appends previous weeks after Week 11."""
...
PREVIOUS = "/home/ds/MonU_Applied_DataS_cience_Project/Status Report/Phase6/CS703 - Week10 Status Report.pptx.submitted"
OUTPUT = "/home/ds/MonU_Applied_DataS_cience_Project/Status Report/Phase6/CS703 - Week11 Status Report.pptx"

WEEK_ENDING = "July 17, 2026"
SUBMIT_DATE = "July 17, 2026"
...
REFLECTION = (
    "With Phase 6 submitted and the finish line in sight, this week felt more "
    "structured than the last. Getting the presentation to 50% gave me a clear "
    "picture of what remains, and the slide outline is starting to tell the full "
    "story of the project from start to finish. The Random Forest results are "
    "strong enough that I feel confident presenting them. The biggest remaining "
    "task is translating all the technical detail into something concise and "
    "visually clear for the audience. I have resisted starting the Final Report "
    "early because I want to focus on one deliverable at a time and do it well. "
    "Next week will be about polishing the slides and rehearsing the flow."
)
...
STATUS_OVERVIEW_LINES = [
    ...
    ([sts("Status: "), seg("GREEN", GREEN_HEX), sts(" — 50% complete")], 10, False, 1),
    ("Original Start: 12 Jul 2026 | Revised: N/A | Actual Start: 11 Jul 2026", 9, False, 1),
    ("Original End:   25 Jul 2026 | Revised: N/A | Actual End: N/A", 9, False, 1),
    ("Task 6.3: Final Report", 11, True, 0),
    ([sts("Status: "), seg("GREEN", GREEN_HEX), sts(" — 0% complete")], 10, False, 1),
    ("Original Start: 25 Jul 2026 | Revised: N/A | Actual Start: N/A", 9, False, 1),
    ("Original End:   1 Aug 2026 | Revised: N/A | Actual End: N/A", 9, False, 1),
]

COMPLETED_LINES = [
    ("Per plan, no items completed this week.", 11, False, 0),
    ("However Task 6.3: Final Presentation is scheduled to be", 10, False, 1),
    ("completed next week.", 10, False, 1),
]
...
IN_PROGRESS_LINES = [
    ...
    ("Original Start: 12 Jul 2026 | Revised: N/A | Actual Start: 11 Jul 2026", 9, False, 1),
    ("Original End:   25 Jul 2026 | Revised: N/A | Actual End: N/A", 9, False, 1),
    ("Slide deck structure finalised; key sections drafted", 10, False, 1),
    ("including project overview, methodology, modelling", 10, False, 1),
    ("results, and conclusions.", 10, False, 1),
]
...
NEXT_STEPS_LINES = [
    ("Task 6.3: Final Presentation (continue)", 11, True, 0),
    ("Original Start: 12 Jul 2026 | Revised: N/A | Actual Start: 11 Jul 2026", 9, False, 1),
    ("Original End:   25 Jul 2026 | Revised: N/A | Actual End: N/A", 9, False, 1),
    ("Task 6.3: Final Report", 11, True, 0),
    ("Original Start: 25 Jul 2026 | Revised: N/A | Actual Start: N/A", 9, False, 1),
...
def build_week11_presentation():
    """Build and return Week 11 as a standalone Presentation with 11 slides."""
    ...
    fill_content_slide(
        ...
        [
            ("Final Presentation — Slide Deck Outline and Narrative Structure", 11, True, 0),
            ("", 6, False, 0),
            ("Slide Deck Outline (In Progress):", 10, True, 0),
            ("  - Project Overview: business problem, all business &", 10, False, 0),
            ("    data mining goals/objectives, background material", 10, False, 0),
            ("  - Summary of Each Phase: key components per phase", 10, False, 0),
            ("    as they relate to project goals", 10, False, 0),
            ("  - Data Cleansing: how and why data was cleansed and", 10, False, 0),
            ("    standardized (may combine with parts 4 & 5)", 10, False, 0),
            ("  - Phase 4.0 \u2014 Modeling: all data visualizations meeting", 10, False, 0),
            ("    business goals, actual models with explanation,", 10, False, 0),
            ("    insight provided, potential business impact", 10, False, 0),
            ("    (may combine with parts 3 & 5)", 10, False, 0),
            ("  - LIVE Demonstration: video showing code execution", 10, False, 0),
            ("    and working models that coincide with models shown", 10, False, 0),
            ("    above (may combine with parts 3 & 4)", 10, False, 0),
            ("  - Lessons Learned: Technology, Management, and", 10, False, 0),
            ("    Personal lessons learned", 10, False, 0),
            ("  - Conclusion: did the project meet Business and Data", 10, False, 0),
            ("    Mining goals? Why or why not? Final thoughts", 10, False, 0),
        ],
    )
...
# ===== MAIN =====
prs = build_week11_presentation()
print(f"Week 11 built: {len(prs.slides)} slides")

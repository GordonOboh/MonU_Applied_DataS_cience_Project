...
%\noindent
For modeling, the project used Random Forest, Gradient Boosting, and XGBoost. Tree-based models were selected based on EDA.
...
\begin{figure}[ht!]
  \centering
  \includegraphics[height=250pt]{Assignment/week14/charts/CRISP-DM.png}
